...
class BERT:
    ...
    def run_pretrain(self):
        ...
        train_loader, val_loader, self.test_loader_pretrain = create_dataloader_pretrain(
            ...
            self.config_dict, self.word2id, val_split, 
    ...
    def run_finetune(self):
        ...
        self.bert_finetune_ds = PreprocessBERTFinetune(self.config_dict, self.wordpiece, self.word2id)
        ...
        train_loader, val_loader, self.test_loader = create_data_loader_finetune(
            tokens, start_ids, end_ids, topics, 
    ...
    def run_infer_finetune(self):
        ...
        def get_max_end_index(arr, start_indices):
            ...
            mask = np.stack([np.arange(num_cols)]*num_rows) <= np.expand_dims(start_indices, 1)
            masked_arr = arr
            masked_arr[mask] = -1e9
    ...
    def load_pretrain_weights(self, pretrain_model, finetune_model):
        ...
        finetune_model.embed_layer.load_state_dict(pretrain_model.embed_layer.state_dict())
